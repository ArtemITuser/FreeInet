...
После того, как Вы запустите [CloudFlare WARP](https://one.one.one.one/) (убедитесь что установлен режим "1.1.1.1 with WARP"), запустите только HTTP PROXY в программе. Далее GoodByeDPI и DoH Proxy не нужны. 
