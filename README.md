...
Прежде всего необходимо [последнюю версию программы]([https://github.com/i9a4/FREENET/releases/tag/Release](https://github.com/i9a4/FREENET/releases)), разархивировать архив и запустить файл "FREENET.exe"
