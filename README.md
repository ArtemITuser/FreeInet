...
# Если у вас не работает YouTube
Установите следующие параметры для Основного средства обхода ТСПУ: -p -e 1

# Если вам нужна работа заблокированных сайтов
Установите следующие параметры для Основного средства обхода ТСПУ: -p -e 1 --reverse-frag (некоторые сайты могут не работать)
